                ...
                <div style="background-color: #AEB6BF; padding-top: 50px; padding-bottom: 50px; <?php if(get_option('wporlogin_design') != 'wporlogin_design_premium'){ echo 'display: none'; } ?>"  class="wporlogin-container-design" id="wporlogin-container-premium">
                    ...
                    <div style="display: flex; flex-wrap: wrap; justify-content: space-around;">
                        ...
                        <div style="position: relative; margin-bottom: 15px;">
                            ...
                            <img onclick="wporloginimgclick('wporlogin-design-img-premium-one')" id="wporlogin_url_img_fondo_img" src="<?php echo esc_url(plugin_dir_url( __FILE__ ).'../img/wporlogin-design-premium-one.jpg'); ?>" style="margin-bottom: 10px; max-width: 100%; height: auto; cursor: pointer;">
                        ...
                        <div style="position: relative; margin-bottom: 15px;">
                            ...
                            <img onclick="wporloginimgclick('wporlogin-design-img-premium-two')" id="wporlogin_url_img_fondo_img" src="<?php echo esc_url(plugin_dir_url( __FILE__ ).'../img/wporlogin-design-premium-two.jpg'); ?>" style="margin-bottom: 10px; max-width: 100%; height: auto; cursor: pointer;">
                        ...
                        <div style="position: relative; margin-bottom: 15px;">
                            ...
                            <img onclick="wporloginimgclick('wporlogin-design-img-premium-three')" id="wporlogin_url_img_fondo_img" src="<?php echo esc_url(plugin_dir_url( __FILE__ ).'../img/wporlogin-design-premium-three.jpg'); ?>" style="margin-bottom: 10px; max-width: 100%; height: auto; cursor: pointer;">
                            
                        </div>

                        <script>function wporloginimgclick(valor){document.getElementById(valor).checked=true;}</script>
                    </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p class="description" id="tagline-description"><?php _e("You'll get the best results with a", 'wporlogin'); ?> <strong><?php _e('dimension of 200 by 84 pixels', 'wporlogin'); ?>.</strong></p>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                     ...
                                     */
                                    if( get_option('wporlogin_url_img_fondo') == false ) { // Si el valor es vacio

                                    ?>
                                    <div style="margin-bottom: 20px;">

                                        <input type="radio" checked id="wporlogin_free_images" name="wporlogin_background_images" value="wporlogin_free_images">
                                        <label id="wporlogin_free_images" for="wporlogin_free_images"><?php _e('Free images', 'wporlogin'); ?></label>
                                        
                                        <input type="radio" id="wporlogin_my_images" name="wporlogin_background_images" value="wporlogin_my_images" style="margin-left: 20px;">
                                        ...
                                        if(get_option('wporlogin_background_images') == false){ // Si el valor es vacio
                                        
                                        ?><div style="margin-bottom: 20px;">

                                        <input type="radio" id="wporlogin_free_images" name="wporlogin_background_images" value="wporlogin_free_images">
                                        <label id="wporlogin_free_images" for="wporlogin_free_images"><?php _e('Free images', 'wporlogin'); ?></label>
                                        
                                        <input type="radio" checked id="wporlogin_my_images" name="wporlogin_background_images" value="wporlogin_my_images" style="margin-left: 20px;">
                                        <label id="wporlogin_my_images" for="wporlogin_my_images"><?php _e('My images', 'wporlogin'); ?></label>
                                    ...
                                    <div id="wporlogin-container-background-my-image" style="<?php if( (get_option('wporlogin_url_img_fondo') == false ) || ( get_option('wporlogin_background_images') == 'wporlogin_free_images' )){ echo 'display: none;'; } ?>">
                                        <?php
                                        ...
                                        <?php
                                            ...
                                            <img id="wporlogin_url_img_fondo_img" src="<?php echo esc_url(WPORLOGINBACKGROUNDIMAGE[0]); ?>" style="margin-bottom: 10px; width: 220px; padding: 10px; background-color: #ffffff; border: 2px dashed rgba(0,0,0,.1);"><br>
                                        <?php } ?>
                                    ...
                                    <div id="wporlogin-container-background-free-image" style="<?php if( ( get_option('wporlogin_url_img_fondo') == true ) && ( (get_option('wporlogin_background_images') == 'wporlogin_my_images' ) || get_option('wporlogin_background_images') == false )){ echo 'display: none;'; } ?>">

                                        <p class="description"><?php _e('You can select a background image from here', 'wporlogin'); ?></p>
                                        <p class="description"><?php _e('The images of ', 'wporlogin'); ?><a href="https://unsplash.com/" target="_blank"><strong>Unsplash</strong></a><?php _e(' are made to be used freely', 'wporlogin'); ?>.</p><br><br>
